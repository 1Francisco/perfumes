          ...
          <div className="flex flex-col">
            <div className="border-b border-border pb-12 mb-12">
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-muted mb-8">
                ...
                <span>{t("detail.launch")}: {perfume.launchYear}</span>
                {perfume.perfumer && <span>{t("detail.perfumer")}: {perfume.perfumer}</span>}
              </div>
              ...
              <div className="space-y-3">
                <p className="text-xs uppercase tracking-[0.2em] text-muted mb-4">{t("detail.whereToBuy")}</p>
                <a 
            ...
            <div className="mb-8">
              <h2 className="font-serif text-3xl mb-8">{t("detail.pyramid")}</h2>
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none text-muted leading-relaxed mt-12 bg-panel p-8">
              <h4 className="font-serif text-lg mb-4 text-foreground">{t("detail.art")}</h4>
              <p>
                {t("detail.artDesc1")} {perfume.name} {t("detail.artDesc2")}
              </p>
            </div>
